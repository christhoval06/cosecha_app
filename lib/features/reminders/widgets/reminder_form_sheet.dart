          ...
          child: Column(
            ...
            children: [
              ...
              FormBuilderSwitch(
                ...
                onChanged: (valueCandidate) {
                  if (valueCandidate == true) {
                    _formKey.currentState?.fields[_destinationField]?.didChange(
                      _formKey.currentState?.fields[_destinationField]?.value ??
              ...
              FormBuilderDropdown<String>(
                ...
                enabled:
                    _formKey.currentState?.fields[_openDestinationField]?.value
                        as bool? ??
