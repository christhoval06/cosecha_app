...
String _avgTicketTrendTitle(AppLocalizations l10n) => l10n.homeWidgetAvgTicketTrend;
String _productsAtRiskTitle(AppLocalizations l10n) => l10n.homeWidgetProductsAtRisk;
String _weeklyActivityTitle(AppLocalizations l10n) => l10n.homeWidgetWeeklyActivity;
String _weeklyInsightsTitle(AppLocalizations l10n) => l10n.homeWidgetWeeklyInsights;
...
Widget _buildQuickActionsPanel(BuildContext context) => const HomeQuickActionsPanel();
Widget _buildSalesGoalPanel(BuildContext context) => const HomeSalesGoalPanel();
Widget _buildChannelMixPanel(BuildContext context) => const HomeChannelMixPanel();
...
Widget _buildRecentSalesPanel(BuildContext context) => const HomeRecentSalesPanel();
